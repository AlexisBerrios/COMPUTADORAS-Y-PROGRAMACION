...
void main()
{
	...
	Yderecha = pixeles_alto * porcenjate_alto + Yizquierda;

	printf_s("%i %i %5.2f %5.2f %5.2f %5.2f %i %i %i %i", pixeles_ancho, pixeles_alto, porcentajeX, porcentajeY, porcentaje_ancho, porcenjate_alto, Xizquierda, Yizquierda, Xderecha, Yderecha);
